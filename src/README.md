...
oraz listener eventów frameworka:

- `NimblePHP\Secure\SecureEventListener` (podpięty pod eventy `BeforeControllerEvent`,
  `ProcessingModelDataEvent`, `BeforeLogEvent`, `AfterLogEvent` — obsługa rate limitu,
  modeli i logów)
